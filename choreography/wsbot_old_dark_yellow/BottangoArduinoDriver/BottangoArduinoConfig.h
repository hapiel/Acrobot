...
#define EXPORTED_ANIMATION_INPUT INPUT_PULLUP                      // what kind of input to use for pin monitoring for triggering animations. Change to INPUT_PULLDOWN or INPUT_PULLUP if desired.
...
#ifdef RELAY_CHILD
#define ESPNOW_PARENT_ADDRESS {0xf0, 0x24, 0xf9, 0xb6, 0xa7, 0xdc} // mac address of parent
#endif
#endif
