...
{
  float target = fmod(fmod(startPositions[limbIndex] , 360) + 360, 360); // 358
  float current = fmod(fmod(limbs[limbIndex]->getTarget() , 360) + 360, 360); // case 1 = 355, case 2 = 5
  float error = target - current; // case 1 = 3, case 2 = 353
